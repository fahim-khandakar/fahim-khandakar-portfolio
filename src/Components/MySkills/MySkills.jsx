...
const MySkills = () => {
  const linkArr = [
    ...
    { link: "https://skillicons.dev/icons?i=prisma", name: "Prisma" },
    { link: "https://skillicons.dev/icons?i=mongo", name: "MongoDB" },
    { link: "https://skillicons.dev/icons?i=postgresql", name: "Postgres" },
      ...
      <Container>
        <div className="flex gap-5 md:gap-14 flex-wrap justify-center text-center text-sm md:text-base">
          {linkArr?.map((item, index) => (
            <div
              key={index}
              className="bg-[#2b303236] inline-block px-3 py-3  md:px-5 md:py-3 rounded-md shadow-lg"
            >
              <img
